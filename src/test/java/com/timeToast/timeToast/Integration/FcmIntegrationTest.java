...
public class FcmIntegrationTest extends TestContainerSupport {
    ...
    @Autowired
    public FcmIntegrationTest(final FcmService fcmService, final MemberRepository memberRepository, final FcmServiceImpl fcmServiceImpl, final EventToastService eventToastService) {
    ...
    public void tryToGetAlarm() {
        ...
        FcmPostRequest fcmPostRequest = new FcmPostRequest(FcmConstant.EVENTTOASTOPENED, 1L, "toastName", responseWithId.id());
