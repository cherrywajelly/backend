        ...
        mockMvc.perform(
                ...
                .andDo(document("로그인한 유저의 이벤트 토스트 목록 조회",
                        resource(ResourceSnippetParameters.builder()
                                ...
                                .responseFields(
                                        fieldWithPath("eventToastMyResponses[0].eventToastId").type(NUMBER).description("이벤트 토스트 id"),
                                        ...
                                        fieldWithPath("eventToastMyResponses[0].icon.iconId").type(NUMBER).description("이벤트 토스트의 아이콘 id"),
