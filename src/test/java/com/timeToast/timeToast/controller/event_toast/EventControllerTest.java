                ...
                .andDo(document("관리자 이벤트 토스트 상세 조회",
                        resource(ResourceSnippetParameters.builder()
                                ...
                                .responseFields(
                                        ...
                                        fieldWithPath("isOpened").type(STRING).description("이벤트 토스트 열림 여부"),
                                        fieldWithPath("createdAt").type(STRING).description("이벤트 토스트 생성 날짜"),
                                        fieldWithPath("jamManagerResponses.jamManagerResponses[0].jamId").type(STRING).description("이벤트 토스트의 잼 id"),
