...
public class PaymentRepositoryImpl implements PaymentRepository {
    ...
    @Override
    public List<PaymentSummaryDto> findPaymentSummaryDto() {
        return queryFactory.select(Projections.constructor(
                PaymentSummaryDto.class, payment.itemId,iconGroup.name, iconGroup.iconType,payment.count()))
                .from(payment)
                .join(iconGroup).on(payment.itemId.eq(iconGroup.id))
    ...
    @Override
    public List<PaymentSummaryDto> findPaymentSummaryDtoByYearMonth(final int year, final int month) {
